...
<div class="container">
    <div class="shadow-sm banner_section p-3 my-3 bg-light rounded">
        ...
        if(isset($_POST['ci']) && isset($_POST['password'])){
            ...
            $resultado = mysqli_query($con, "select * from usuario where password=MD5('".$password."') and ci='".$ci."';");
            //print_r($resultado);
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="number" class="form-control" 
                    placeholder="Introduzca su usuario" name="ci" defaultValue="<?php echo "test";?>">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control"
                    placeholder="Introduzca su contraseña" name="password">
            </div>
