    ...
    ?>
        <div class="container ">
            <div class="row d-flex justify-content-between ">
                <div class="col-sm-1 ">
                    <div class="logo"><a href="index.php"><img src="../images/carrera.jpg"></a></div>
                </div>
                <div class="col-sm-8 ">
                    <div class="menu-area ">
                        <nav class="navbar navbar-expand-lg ">
                            ...
                            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    <li class="nav-item">
                                        <a class="nav-link  p-3" href="../signup.php?edit=edit">Datos Personales</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link p-3" href="fisica.php">Mis postulaciones</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link  p-3" href="quimica.php">Inscribirse Materias</a>
                                    </li>
